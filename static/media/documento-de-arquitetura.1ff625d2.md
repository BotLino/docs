...
<p  align="justify">  &emsp;&emsp;Este documento apresenta a arquitetura de software aplicada no desenvolvimento do ChatBot Lino, promovendo a visualização dos requisitos, da estruturação e diagramação da arquitetura definida.</p>
...
<p  align="justify">  &emsp;&emsp;O documento detalha a arquitetura e os requisistos do sóftware através de 4 principais tópicos e suas ramificações, na seguinte estrutura:</p>
...
<p  align="justify">  &emsp;&emsp;A principal tecnologia do ChatBot é o <i>Rasa NLu</i>. Esta tecnologia trabalha com o processamento natural de linguagem, a partir dela o desenvolvedor abre portas relacionadas ao processamento de texto que o permitem criar um ambiente de comunicação mais interativo e humano, além de uma comunicação mais fluida e dinâmica com o usuário.</p>
<p  align="justify">  &emsp;&emsp;Ao permitir essa comunicação mais humanizada, é possível estar em uma maior interatividade com o usuário. Com o tempo, a interação com o usuário permitirá ao programa um treinamento dele mesmo para melhor se comunicar com o exterior. Este é o principal objetivo da utilização do <i>Rasa NLU</i> para o processamento de linguagem do projeto em questão.</p>
<p  align="justify">  &emsp;&emsp;Os principais benefícios da tecnologia são:</p>
...
<p  align="justify">  &emsp;&emsp;O <i>Telegram</i> e <i>Messenger</i> são aplicativos de comunicação e  bate-papo comumente utilizados para a conversação em grupo ou de uma pessoa com outra. Os dois aplicativos proveem aos desenvolvedores a possibilidade de implementarem diferentes funcionalidades e <i>bots</i>, a partir de suas APIs.</p>
...
<p  align="justify">  &emsp;&emsp;A tecnologia MongoDB é um banco de dados <i>open-source</i> orientado a documentos e classificado como NoSQL, que utiliza documentos com padrão JSON.</p>

<p  align="justify">  &emsp;&emsp;Esta tecnologia se comunicará com o projeto de maneira a receber os dados fornecidos pelas conversas e interações realizadas no Lino e as armazenará em um banco de dados, para posteriormente serem usadas na metrificação da utilização do ChatBot.</p>
...
<p  align="justify">  &emsp;&emsp;<i>Elasticsearch</i> é um mecanismo de pesquisa baseado em <i>Representational state transfer</i>(REST) capaz de processar dados, tirados do banco de dados, podendo metrificá-los, funcionando no <i>back-end</i> de um projeto.</p>

<p  align="justify">  &emsp;&emsp;No projeto, o <i>Elasticsearch</i> será capaz de captar os dados armazenados no banco de dados, realizando seu processamento e metrificação para a chegada em conclusões.</p>
...
<p  align="justify">  &emsp;&emsp;A ferramenta trabalhará com os dados metrificados captados do <i>Elasticsearch</i> e os transformará em gráficos de fácil análise, agindo como o <i>front-end</i> das metrificações.</p>
...
* Disponibilizar um fluxo de conversa com o usuário afim de atender/suprir dúvidas em relação à procedimentos voltados à comunidade acadêmica realizados na Universidade de Brasília.
